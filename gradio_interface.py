...
def gradio_train(selected_features, learning_rate, steps, stochastic, learning_rate_decay, scheduler):
    if len(selected_features) == 0:
        ...
        x_train, quartiles = create_training_data(dataset_selected)
        ...
        return figure, final_accuracy, selected_features, weights_df, quartiles
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Train"):
        ...
        train_button.click(
            ...
            outputs=[figure, accuracy, selected_features_state, weights_state, quartiles_state],
        )
    with gr.Tab("Predict"):
        with gr.Row():
            with gr.Column():
            ...
            predict_button.click(fn=gradio_predict, inputs=[selected_features_state, weights_state, quartiles_state], outputs=[prediction])
